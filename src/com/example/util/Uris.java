...
public final class Uris {
	public static final String[] IMAGES = new String[] {
		// Heavy images
		"http://cdn.duitang.com/uploads/item/201209/05/20120905104848_Bh3BR.thumb.600_0.gif",
	...
	//评论段子
	public static String Post_Comment = "http://md.maimob.net/index.php/player/Comment";
	//读取可供审核的段子
	public static String Check = "http://md.maimob.net/index.php/player/FetchPlayerPost";
	//审核段子
	...
	public static int MSG_GETDATA = 2;
}
