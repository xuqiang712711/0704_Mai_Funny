...
public class My_InfoEdit extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_userinfo_edit);
		initView();initAddressPop();
	}
	
	private void initView(){
		user = SerUser.deSerializationUser((String) SharedPreferencesUtils
				.getParam("SerUser", this, "user", ""));
		...
		TextView right = (TextView)findViewById(R.id.top_right_change2);
		right.setVisibility(View.GONE);
		
		layout_icon  = (RelativeLayout)findViewById(R.id.my_edit_icon);
		layout_name = (RelativeLayout)findViewById(R.id.my_edit_name);
		layout_Signature = (RelativeLayout)findViewById(R.id.my_edit_Signature);
		layout_address = (RelativeLayout)findViewById(R.id.my_edit_address);
		layout_sex = (RelativeLayout)findViewById(R.id.my_edit_sex);
		...
		iv_Icon = (ImageView)findViewById(R.id.my_edit_icon_image);
		
		tv_Name = (TextView)findViewById(R.id.my_edit_name_right);
		tv_Signature = (TextView)findViewById(R.id.my_edit_Signature_right);
		tv_sex = (TextView)findViewById(R.id.my_edit_sex_right);
		tv_address = (TextView)findViewById(R.id.my_edit_address_right);
		...
		adapter_Pic = new ArrayAdapter<String>(this, android.R.layout.select_dialog_item, items);
		builder_Pic = new AlertDialog.Builder(this);
		   ...
		   @Override
			public void onClick(View v) {
				...
				case R.id.my_edit_name:
					...
					new AlertDialog.Builder(this).setView(et_input).setTitle("编辑昵称")
...
//							SharedPreferencesUtils.setParam(SharedPreferencesUtils.user, this, SharedPreferencesUtils.user_name, content);
							user.setName(content);
							tv_Name.setText(content);
							dialog.dismiss();
							mFragmentManage.Refresh_userInfo = true;
							user.saveUser(My_InfoEdit.this, SerUser.serializeUser(user));
				...
				case R.id.my_edit_Signature:
					...
					new AlertDialog.Builder(this).setView(et_input).setTitle("编辑签名").setNegativeButton("取消", new DialogInterface.OnClickListener() {
...
//					new AlertDialog.Builder(this).setView(et_input).setTitle("编辑地址").setNegativeButton("取消", new DialogInterface.OnClickListener() {
//						
//						@Override
//						public void onClick(DialogInterface dialog, int which) {
//							// TODO Auto-generated method stub
...
//					.show();
				...
				case R.id.my_edit_sex:
					...
					new AlertDialog.Builder(this).setTitle("编辑性别").setNegativeButton("取消", new DialogInterface.OnClickListener() {
		   ...
		   @Override
			public void onDestroy() {
				...
				super.onDestroy();
				if (needRefresh) {
					mFragmentManage.RefreshFrag(this, mFragmentManage.Tag_Userinfo);
				}
			}
